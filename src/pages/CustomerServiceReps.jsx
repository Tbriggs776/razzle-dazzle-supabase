    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 py-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <h1 className="text-3xl font-bold text-slate-800 tracking-tight">Customer Service Reps</h1>
              <p className="text-slate-500 mt-1">Team members who handle customer inquiries and support</p>
            </div>
            <Button
              onClick={() => setShowCreateDialog(true)}
              className="bg-green-600 hover:bg-green-700 text-white h-12 px-6 rounded-xl shadow-lg shadow-green-200 hover:shadow-xl hover:shadow-green-200 transition-all"
            >
          ...
          <div className="mt-8 relative">
            ...
            <Input
              ...
              className="pl-12 h-14 bg-slate-50 border-slate-200 rounded-xl text-base focus:bg-white focus:border-green-500 focus:ring-green-500 transition-all"
            />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        {isLoading ? (
          ...
          >
            <div className="w-20 h-20 mx-auto rounded-2xl bg-green-50 flex items-center justify-center mb-6">
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-slate-800">New Customer Service Rep</DialogTitle>
          </DialogHeader>
          <TeamMemberForm
