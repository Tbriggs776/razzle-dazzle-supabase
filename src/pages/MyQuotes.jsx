      ...
      <div className="bg-white border-b border-slate-100">
        <div className="max-w-5xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-slate-800">My Quotes</h1>
              <p className="text-slate-500 mt-1">Manage and convert your pending quotes</p>
            </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl border border-slate-100">
            ...
            <h3 className="text-lg font-semibold text-slate-800">No quotes found</h3>
            <p className="text-slate-500 mt-1">Quotes are created from appointment results</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="block bg-white rounded-xl border border-slate-100 hover:shadow-lg hover:border-indigo-200 transition-all p-6"
                  >
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          ...
                          {quote.status !== 'Converted' && (
                            <Badge variant="secondary" className="border bg-indigo-50 text-indigo-700 border-indigo-200">
                              Quote
                            </Badge>
                          )}
                          {quote.status === 'Converted' && (
                            <Badge variant="secondary" className="border bg-emerald-50 text-emerald-700 border-emerald-200">
                              ✓ Converted to Sale
                            </Badge>
                          )}
                        </div>
