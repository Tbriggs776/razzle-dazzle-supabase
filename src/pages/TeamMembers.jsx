              ...
              {filteredData.map((item, index) => (
                item.hasTeamMember ? (
                  <div key={item.id} className="relative">
                    ...
                    {!item.hasBase44Access && (
                      <div className="absolute top-3 right-3">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium bg-amber-100 text-amber-700 border border-amber-300">
                          No Base44 Access
                        </span>
                      </div>
                    )}
                  ...
                  <motion.div
                    ...
                    className="bg-white rounded-xl border-2 border-dashed border-red-200 p-6 hover:shadow-lg transition-all cursor-pointer"
                    onClick={() => {
